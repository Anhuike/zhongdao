<template>
	<view id="retroclockbox_counter" class="xdsoft">
		...
		<view class="max_text  flex_between padding-top-10 x_color bold" >
			<view class="flex_center" style="width: 144upx;">
				天
			</view>
			<view class="flex_center" style="width: 144upx;">
				时
	...
	export default {
		...
		methods: {
			...
			count_down(startTime, endTime) {
				...
				let timeArray = [freeDay, freeHour, freeMinute, freeSecond]
				let lastArray = this.zeroFill(timeArray)
